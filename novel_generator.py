...
→ 此類開場和反派設計曾引發強烈爽感，可沿用相近的張力結構"""
    ...
    prompt = f"""你是中文網絡爽文作家。你的故事讓人一口氣讀完，每隔幾段就有一個讓人心跳加速的時刻。
...
【你的任務】
用以上設定寫一篇讓讀者讀完覺得「爽！」的故事。

怎樣才算「爽」：讀者一開始替主角憋屈，最後看到主角翻身時有強烈的情緒釋放。

你自己決定怎麼講這個故事。但有幾條底線：
- 開場要馬上建立衝突，不要鋪墊太久
- 對白要真實有力，反派講話要讓人咬牙，主角回擊要讓人拍手
- 每一段都要推進故事，不要停下來交代背景
- 故事必須寫到完，主角翻身後才結束，不要斷尾
- 結局要乾淨俐落，讓讀者合上時心情暢快
